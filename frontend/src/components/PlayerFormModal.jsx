...
const PlayerFormModal = ({ player, isOpen, onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Error saving player');
    } finally {
            ...
            <Card className="p-6 space-y-4">
              ...
              <div className="text-center">
                <div className="relative inline-block">
                  ...
                  />
                  <div className={`absolute -top-1 -right-1 px-2 py-1 rounded-full bg-gradient-to-r ${positionColors[formData.position]} text-white text-xs font-bold`}>
                    {formData.points}
                  </div>
