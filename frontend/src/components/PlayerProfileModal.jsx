      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-slate-50 to-gray-50 border-0">
            ...
            <div className={`h-2 bg-gradient-to-r ${positionColors[player.position]} rounded-t-lg -m-6 mb-4`} />
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="relative flex-shrink-0">
                ...
                <div className="absolute -top-2 -right-2">
                  <Badge className={`${positionBg[player.position]} border-0 font-bold`}>
                    {player.position}
                  </Badge>
                </div>
              </div>
              ...
              <div className="flex-1 space-y-3">
                <div>
                  <h3 className="text-3xl font-bold text-gray-800">{player.name}</h3>
                ...
                <div className="flex items-center gap-4">
                  <div className={`px-6 py-3 rounded-2xl bg-gradient-to-r ${positionColors[player.position]} text-white shadow-lg`}>
                  ...
                  <div className="text-sm text-muted-foreground">
                    <div className="font-semibold text-gray-700">{getSkillLevel(player.points)}</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                <div className="text-2xl font-bold text-blue-600">
                  {Math.max(...Object.values(player.skills))}
                </div>
              ...
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600">
                  {Math.round(Object.values(player.skills).reduce((a, b) => a + b) / 6)}
                </div>
