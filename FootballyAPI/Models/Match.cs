...
namespace FootballyAPI.Models
{
    public class Match
    {
        ...
        // Tournament reference (nullable for friendly matches)
        public string? TournamentId { get; set; }

        [StringLength(50)]
        public string Round { get; set; } = string.Empty; // Group Stage, Quarter Final, etc.
        ...
        public virtual MatchAnalysis? MatchAnalysis { get; set; }
    }
}